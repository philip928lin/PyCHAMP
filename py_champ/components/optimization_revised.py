...
class Optimization():
    ...
    def setup_ini_model(self, unique_id, gpenv, target="profit", horizon=1, area_split=1,
        ...
        ----------
        unique_id : str
            Name for the optimization model.
        gpenv : gurobi object
            Gurobi environment for optimization.
        target : str, optional
        ...
        self.model = gp.Model(name=self.unique_id, env=gpenv)
